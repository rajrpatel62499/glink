...
@Component({
  selector: 'app-figma-package-search',
  templateUrl: './figma-package-search.component.html',
  styleUrls: ['./figma-package-search.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations,
})
export class FigmaPackageSearchComponent implements OnInit {
